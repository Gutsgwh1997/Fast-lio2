...
namespace fastlio
{
    ...
    public:
        ...
        void setSharedDate(const std::shared_ptr<ReLocSharedData> &shared_data)
        {
        ...
        void setLocalizer(const std::shared_ptr<fastlio::IcpLocalizer> &localizer)
        {
        ...
        void operator()()
        {
            LOG_INFO("Start relocalizer thread!");
    ...
    {
    public:
        LocalizerROS(tf2_ros::TransformBroadcaster &br, std::shared_ptr<ReLocSharedData> shared_data) : shared_data_(shared_data), br_(br)
        {
            initParams();
            initSubscribers();
            initPublishers();
